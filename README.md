...
| Tool | Description |
|------|-------------|
| `search` | Semantic search across indexed books. Filter by subject, library, book_id, or block_type (use `Code` for code examples). Results include same-page image links when available. |
